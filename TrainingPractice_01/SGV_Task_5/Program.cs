...
namespace SGV_Task_5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Поздравляем, Вы прошли Лабиринт за {0} {1} и на своем пути вы одержали победу над {2} \"{3}\"", turn, turn_string, enemy1, enemy_string);
            Console.ReadKey();
        }
